...
<h3 class="uk-card-title uk-margin-remove uk-text-primary green_title">CHARGED - <span id="cvvCount">0</span>
...
<h3 class="uk-card-title uk-margin-remove uk-text-primary warn_title">Approved(CVV/CCN) - <span id="ccnCount">0</span>
