...
<ul class="uk-nav uk-nav-default doc-nav">
  <li class="uk-active"><a href="https://t.me/<?php echo $group; ?>">Join Group</a></li>
  <li><a href="https://t.me/<?php echo $group; ?>">Join Channel</a></li>
</ul>
...
<li><a href="https://t.me/<?php echo $channel; ?>">CHANNEL</a></li>
<li><a href="https://t.me/<?php echo $group; ?>">GROUP</a></li>
<li><a href="https://t.me/<?php echo $dm; ?>">HIT SENDER</a></li>
  </ul>
</div>

<div class="uk-margin-medium uk-text-small uk-link-muted">
 Crafted by <a href="https://t.me/<?php echo $dm; ?>"><?php echo $by; ?></a></div>
  </div>
</footer>